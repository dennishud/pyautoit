...
UrlGitHub = "https://github.com/YourOnlineAccount/pyautoit/tree/master"
...
def ReadFileAndReplaceKeywords(FilePath,FileName):
    ...
    for i in range(2, ColCount+1, 1):
        Cell_OldString=unicode(table_ContentToReplace.Cells(i, Cell_OldString_Col).Value)
        Cell_NewString=unicode(table_ContentToReplace.Cells(i, Cell_NewString_Col).Value)
...
def ProcessFilename(OldFileName):
    ...
    for i in range(2, ColCount+1, 1):
        Cell_OldString=unicode(table_FilenameToReplace.Cells(i, Cell_OldString_Col).Value)
        Cell_NewString=unicode(table_FilenameToReplace.Cells(i, Cell_NewString_Col).Value)
